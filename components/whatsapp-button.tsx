  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      ...
      <a
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center pulse-whatsapp transition-transform hover:scale-110"
      >
